...
package com.android.settings.icj;
...
public class PlatLogoActivity extends Activity {
            ...
            if (mCount <= 3) {
                ...
                try {
                    startActivity(new Intent(Intent.ACTION_MAIN)
                        ...
                        .setClassName("com.android.settings","com.android.settings.icj.Nyandroid"));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToast = Toast.makeText(this, "IceColdJelly", Toast.LENGTH_SHORT);
